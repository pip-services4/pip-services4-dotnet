...
namespace PipServices4.Rpc.Test.Sample
{
    public sealed class DummyService : IDummyService, ICommandable
    {
        ...
        {
            return await Task.FromResult(context != null ? ContextResolver.GetTraceId(context) : null);
        }

        public Task RaiseExceptionAsync(IContext context)
        {
            throw new NotFoundException(context != null ? ContextResolver.GetTraceId(context) : null, "TEST_ERROR", "Dummy error in controller!");
        }
