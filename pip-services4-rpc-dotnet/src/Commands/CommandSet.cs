...
namespace PipServices4.Rpc.Commands
{
    ...
    public class CommandSet
    {
        ...
        /// See <see cref="ICommand"/>,
        /// <a href="https://pip-services4-dotnet.github.io/pip-services4-commons-dotnet/class_pip_services3_1_1_commons_1_1_run_1_1_parameters.html"/>Parameters</a>
        public Task<object> ExecuteAsync(IContext context, string command, Parameters args)
        {
        ...
        public async Task NotifyAsync(IContext context, string ev, Parameters value)
        {
            var e = FindEvent(ev);

            if (e != null)
                await e.NotifyAsync(context, value);
        }
    }
}