...
namespace PipServices4.Grpc.Controllers
{
    ...
    /// </code>
    /// </example>
    public class CommandableGrpcController : GrpcController
    {
        ...
        public CommandableGrpcController(string name = null)
        ...
        {
            var controller = _dependencyResolver.GetOneRequired<ICommandable>("service");
