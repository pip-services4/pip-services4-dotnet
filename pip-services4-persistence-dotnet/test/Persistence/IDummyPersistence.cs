...
namespace PipServices4.Persistence.Test.Persistence
{
    public interface IDummyPersistence
    {
        ...
        Task<DataPage<Dummy>> GetAsync(IContext context, FilterParams filter, PagingParams paging);
        Task<DataPage<object>> GetAsync(IContext context, FilterParams filter, PagingParams paging, ProjectionParams projection);
        Task ClearAsync();
        ...
        Task<Dummy> UpdatePartiallyAsync(IContext context, string id, AnyValueMap data);
    }
}
