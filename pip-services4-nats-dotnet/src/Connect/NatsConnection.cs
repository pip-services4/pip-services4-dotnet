...
namespace PipServices4.Nats.Connect
{
    ...
    public class NatsConnection: IMessageQueueConnection, IConfigurable, IReferenceable, IOpenable
    {
        ...
        public async Task OpenAsync(IContext context)
        {
            ...
            {
                _logger.Error(context, ex, "Failed to connect to NATS broker at " + uri);
                throw ex;
            }

            _logger.Debug(context, "Connected to NATS broker at " + uri);
        }
        ...
        public async Task CloseAsync(IContext context)
        {
            ...
            finally
            {
                ...
                _logger.Debug(context, "Disconnected from NATS broker");
            }
