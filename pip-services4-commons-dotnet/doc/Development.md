...
```bash
git clone git@github.com:pip-services4/pip-services4-commons-dotnet.git
```
...
```bash
nuget pack PipServices4.Commons.nuspec
```

Publish the package on nuget global repository

```bash
nuget push PipServices4.Commons.XXX.nupkg -Source https://www.nuget.org/api/v2/package
```
