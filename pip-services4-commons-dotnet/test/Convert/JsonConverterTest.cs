...
namespace PipServices4.Commons.Test.Convert
{
    ...
    public sealed class JsonConverterTest
    {
        ...
        public void TestToJson()
        {
            ...
            var filter = AnyValueMap.FromTuples("Key1", 123, "Key2", "ABC");
        ...
        public void TestFromJson()
        {
            ...
            var filter = JsonConverter.FromJson<AnyValueMap>("{\"Key2\":\"ABC\",\"Key1\":\"123\"}");
        ...
        public void TestJsonToObject()
        {
            ...
            var newTestObject = JsonConverter.FromJson<object>(json);

            Assert.NotNull(newTestObject);
        }
    }
}
