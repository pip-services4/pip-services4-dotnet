...
namespace PipServices4.Commons.Errors
{
    ...
    public class TooManyRequestsException : ApplicationException
    {
        ...
        /// <param name="message">(optional) a human-readable description of the error.</param>
        /// <param name="innerException">an error object</param>
        public TooManyRequestsException(string traceId = null, string code = null, string message = null, Exception innerException = null) 
            : base(ErrorCategory.TooManyRequests, traceId, code, message)
        {
            Status = 429;
            WithCause(innerException);
        }
