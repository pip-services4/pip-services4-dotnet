...
namespace PipServices4.Commons.Errors
{
    ...
    public class NotFoundException : ApplicationException
    {
        ...
        /// <param name="message">(optional) a human-readable description of the error.</param>
        /// <param name="innerException">an error object</param>
        public NotFoundException(string traceId = null, string code = null, string message = null, Exception innerException = null) 
            : base(ErrorCategory.NotFound, traceId, code, message)
        {
            Status = 404;
            WithCause(innerException);
        }
