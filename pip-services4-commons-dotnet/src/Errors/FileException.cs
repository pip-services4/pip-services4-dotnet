...
namespace PipServices4.Commons.Errors
{
    ...
    public class FileException : ApplicationException
    {
        ...
        /// <param name="message">(optional) a human-readable description of the error.</param>
        /// <param name="innerException">an error object</param>
        public FileException(string traceId = null, string code = null, string message = null, Exception innerException = null) 
            : base(ErrorCategory.NoFileAccess, traceId, code, message)
        {
            Status = 500;
            WithCause(innerException);
        }
