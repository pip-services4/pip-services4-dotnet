...
namespace PipServices4.Commons.Errors
{
    ...
    public class InvocationException : ApplicationException
    {
        ...
        /// <param name="message">(optional) a human-readable description of the error.</param>
        /// <param name="innerException">an error object</param>
        public InvocationException(string traceId = null, string code = null, string message = null, Exception innerException = null) 
            : base(ErrorCategory.FailedInvocation, traceId, code, message)
        {
            Status = 500;
            WithCause(innerException);
        }
