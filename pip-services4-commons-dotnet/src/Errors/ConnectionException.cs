...
namespace PipServices4.Commons.Errors
{
    ...
    public class ConnectionException : ApplicationException
    {
        ...
        /// <param name="innerException">an error object</param>
        public ConnectionException(string traceId = null, string code = null, string message = null, Exception innerException = null) 
            : base(ErrorCategory.NoResponse, traceId, code, message)
        {
            Status = 500;
            WithCause(innerException);
        }
