...
namespace PipServices4.Commons.Errors
{
    ...
    public class UnsupportedException : ApplicationException
    {
        ...
        /// <param name="message">(optional) a human-readable description of the error.</param>
        /// <param name="innerException">an error object</param>
        public UnsupportedException(string traceId = null, string code = null, string message = null, Exception innerException = null) 
            : base(ErrorCategory.Unsupported, traceId, code, message)
        {
            Status = 500;
            WithCause(innerException);
        }
