...
namespace PipServices4.Commons.Errors
{
    ...
    public class UnknownException : ApplicationException
    {
        ...
        /// <param name="message">(optional) a human-readable description of the error.</param>
        /// <param name="innerException">an error object</param>
        public UnknownException(string traceId = null, string code = null, string message = null, Exception innerException = null) 
            : base(ErrorCategory.Unknown, traceId, code, message)
        {
            Status = 500;
            WithCause(innerException);
        }
